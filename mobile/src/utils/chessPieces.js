      ...
      return (
        <Svg width={size} height={size} viewBox="0 0 45 45">
          <G fill={fill} stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Path d="M11 14h23" stroke={secondary} />
          </G>
        </Svg>
      );
    case 'n':
      ...
      return (
        <Svg width={size} height={size} viewBox="0 0 45 45">
          <G fill={fill} stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Path d="M17.5 26h10M15 30h15" stroke={secondary} />
          </G>
        </Svg>
      );
    case 'q':
      return (
        <Svg width={size} height={size} viewBox="0 0 45 45">
          <G fill={fill} stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Path d="M11 38.5a35 35 1 0 0 23 0" stroke={secondary} />
          </G>
        </Svg>
      );
    case 'k':
      return (
        <Svg width={size} height={size} viewBox="0 0 45 45">
          <G fill={fill} stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Path d="M11.5 30c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0" stroke={secondary} />
          </G>
        </Svg>
      );
    default:
