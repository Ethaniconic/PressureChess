// PressureChess Beta Data Catalog & Configuration
...
export const PROFILE_FRAMES = [
  { id: 'beta_founder', name: 'Founding Beta Player', borderStyle: 'border-cyan-400 shadow-glow-cyan', badge: '✨ FOUNDER' },
  { id: 'solar_gold', name: 'Solar Grandmaster', borderStyle: 'border-amber-400 shadow-glow-gold', badge: '👑 GOLD' },
  { id: 'emerald_tactics', name: 'Tactical Prodigy', borderStyle: 'border-emerald-400 shadow-glow-emerald', badge: '⚡ MASTER' },
  { id: 'midnight_classic', name: 'Midnight Sapphire', borderStyle: 'border-slate-600', badge: 'CLASSIC' }
];
